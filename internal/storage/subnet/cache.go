...
func NewSubnetCache(redis *redis.Client, logger *slog.Logger) *SubnetCache {
	return &SubnetCache{
		redis:  redis,
		logger: logger,
		ttl:    defaultCacheTTL,
...
func (c *SubnetCache) GetIPCheckResult(ctx context.Context, ip string) (inWhitelist bool, inBlacklist bool, err error) {
...
func (c *SubnetCache) SetIPCheckResult(ctx context.Context, ip string, inWhitelist bool, inBlacklist bool) error {
	key := ipCheckResultKey(ip)
...
func (c *SubnetCache) SetBothSubnetLists(ctx context.Context, whitelistSubnets, blacklistSubnets []string) error {
...
func (c *SubnetCache) InvalidateAll(ctx context.Context) error {
...
func (c *SubnetCache) AreBothListsCached(ctx context.Context) (bothCached bool) {
...
func (c *SubnetCache) GetBothSubnetLists(ctx context.Context) (whitelistSubnets, blacklistSubnets []string, err error) {
	pipe := c.redis.Pipeline()
...
func (c *SubnetCache) CheckIPInBothCachedSubnets(ctx context.Context, ipStr string) (inWhitelist bool, inBlacklist bool, err error) {
...
func (c *SubnetCache) checkIPInSubnetList(ip net.IP, subnets []string, listType int) bool {
